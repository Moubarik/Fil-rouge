...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v11.0" nonce="OuknxfIt"></script>
<div class="fb-comments" data-href="{{ Request::url() }}" data-width="8" data-numposts="5"></div>
@php
