        ...
        <form class="forms-sample" method="POST" action="{{ route('update.writer',$writer->id) }}">
            @csrf
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="name"  value="{{$writer->name}}" placeholder="Enter Name">
               
              </div>

              <div class="form-group">
                <label for="exampleInputEmail1"> Email</label>
                <input type="email" class="form-control" name="email" value="{{$writer->email}}" placeholder="Enter Email">
    ...
    <div class="col-md-6">
        <div class="form-group">
          ...
          <div class="form-check form-check-info">
            <label class="form-check-label">
              <input type="checkbox" class="form-check-input" name="post" value="1"  @if($writer->post == 1) checked="" @endif> Post <i class="input-helper"></i></label>
          </div>
