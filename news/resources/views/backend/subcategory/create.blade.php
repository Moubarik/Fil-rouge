        ...
        <form class="forms-sample" method="POST" action=" {{route('store.subcategory')}}">
            @csrf
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="subcategory_en"  placeholder="Category English">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="subcategory_fr"  placeholder="Category Arabic">
