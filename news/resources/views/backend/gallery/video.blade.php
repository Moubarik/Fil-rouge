...
<div class="col-lg-12 grid-margin stretch-card">
  ...
  <a href="{{ route('add.video')  }}"><button type="button" class="btn btn-primary btn-fw" style="float: right;">Add Video</button></a>	              	
      ...
      <tr>
        ...
        <td> 
    {{-- <a href="{{ route('video.gallery',$row->id) }}" class="btn btn-info">Edit</a> --}}
    <a href="{{ route('delete.video',$row->id) }}" onclick="return confirm('Are you sure to delete')" class="btn btn-danger">Delete</a>
