...
<div class="content-wrapper">
  ...
  <div class="form-group  ">
    ...
    <select class="form-control" id="subdistrict_id" name="type">
    
        <option class="btn btn-info" value="1">Big Photo </option>
      <option  class="btn btn-danger" value="0"> Small Photo </option>
