    ...
    <div class="row">
        @csrf
                ...
                <div class="form-group col -md-6">
                    ...
                    <input type="text" class="form-control" id="exampleInputName1" name="title_fr"  value="{{ $post->title_fr }}" >
                </div>
...
<div class="row">
    ...
    <div class="form-group col-md-6">
     ...
     <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="exampleInputName1" name="tags_fr" value="{{ $post->tags_fr }}">
    </div>
...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <textarea class="form-control" name="details_fr" id="summernote1">
       {{ $post->details_fr }}
    </textarea>
                      </div>
